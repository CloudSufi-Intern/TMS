...
public class UserControllerTest {
    ...
    void getUser_whenNoParametersProvided_shouldReturnBadRequest() throws Exception {
        ...
        mockMvc.perform(get("/api/user"))
                ...
                .andExpect(result -> assertEquals("At least one search parameter (id, username, or email) must be provided.", result.getResolvedException().getMessage()));
    ...
    @Test @DisplayName("GET /api/user/search - Should return user suggestions for matching username prefix")
